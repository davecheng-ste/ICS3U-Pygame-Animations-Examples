...
Author: D. Cheng
Date: 2024-05-16
Description: Example Pygame animation - moving sprite on background image with debug info.
"""
...
while running:
    ...
    # DEBUG: Output fish (x, y) coordinates
    print(f"fish_rect position at ({fish_rect.x}, {fish_rect.y})")
